...
<i><b>Disclaimer:</b> This is "vibecoded" for personal use, but feel free to use. I do not take responsibility if something is not working on your system</i>
...
![Filewake demo](README_ASSETS/Process_Compressed.gif)
